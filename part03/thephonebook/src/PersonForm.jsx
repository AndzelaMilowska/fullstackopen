...
export default function PersonForm({ newName, setNewName, newNumber, setNewNumber, persons, setPersons, setMessage, setErrorMessage }) {
      ...
      services
        ...
        .then((response) => {
          ...
          setPersons([...persons, response]);
           messageText = newPerson.name + " has been added to the phonebook";
    ...
    setTimeout(() => {
      ...
      services.updateContact(updatedContact).then(() => {
        services.getAll().then((response) => {
          setPersons(response);
          messageText = updatedContact.name + " has been successfully updated";
          setMessage(messageText);
    setTimeout(() => {
      setMessage(null);
    }, 5000);
